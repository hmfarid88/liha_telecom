                                            ...
                                            <tbody id="myTable">
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select PRODUCT_NAME, BOX, PRODUCT_ID, MODEL, SELL_PRICE, DISCOUNT, DIS_NOTE, VENDOR, INVOICE_NO, CUSTOMER_ID, DATE from accessor_sale where DATE between '"+ date1 +"' and '"+ date2 +"' order by DATE ";
