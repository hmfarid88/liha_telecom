...
public class AsalerolbackServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query1 = "insert into accessoriesstock (PRODUCT_NAME, BOX, MODEL, PRODUCT_ID, COST_PRICE, SELL_PRICE,"
                    + " VENDOR, DATE) select PRODUCT_NAME, BOX, MODEL, PRODUCT_ID, COST_PRICE, STOCK_RATE,"
