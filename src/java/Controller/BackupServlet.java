...
//        String too = "tofayel.rana@gmail.com";
        ...
        Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
            protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
                return new javax.mail.PasswordAuthentication("info.iyadsoft@gmail.com", "gsvvomgdfnjnogsy");//Put your email id and password here
            }
        });
...
//            message.addRecipient(Message.RecipientType.TO, new InternetAddress(too));
            message.setSubject("Data Backup From liha_telecom");
                        
        MimeBodyPart messageBodyPart = new MimeBodyPart();
        Multipart multipart = new MimeMultipart();
       
        String file = "D:\\Backup\\liha_telecom.sql";
        
        String fileName = "liha_telecom.sql";
        ...
        message.setContent(multipart);
            ...
            File f=new File("D:\\Backup\\liha_telecom.sql");
            f.delete();
